...
The last one available is from 7th November 2018, if new ones will be made available, they will be updated here
```{r, echo = FALSE, include = FALSE}
# If files are not zipped
# listings_detailed <- read.csv(file.path(getwd(), "airbnb_data", "07.11_listings_detailed.csv", fsep="/"),
#                               sep = ",", header = TRUE, stringsAsFactors = FALSE, encoding = "UTF-8",
#                               na.strings = c("NA", ""))
# listings_summarized <- read.csv(file.path(getwd(), "airbnb_data", "07.11_listings_summary.csv", fsep="/"),
#                                 sep = ",", header = TRUE, stringsAsFactors = FALSE, encoding = "UTF-8",
#                                 na.strings = c("NA", ""))
# listings_calendar <- read.csv(file.path(getwd(), "airbnb_data", "07.11_listings_calendar.csv", fsep="/"),
#                               sep = ",", header = TRUE, stringsAsFactors = FALSE, encoding = "UTF-8",
#                               na.strings = c("NA", ""))
...
```{r}
# The dataframe bahn_stations_df is created in 02_spatial_data.Rmd
