...
listings_detailed <- utils::read.csv("18.10_listings_detailed.csv", sep=",", header=TRUE,
                         encoding = "UTF-8", na.strings = c("NA", ""),
                         stringsAsFactors = FALSE)
listings_summarized <- utils::read.csv("18.10_listings_summary.csv", sep=",", header=TRUE, 
                         encoding = "UTF-8", na.strings = c("NA", ""),
                         stringsAsFactors = FALSE)
