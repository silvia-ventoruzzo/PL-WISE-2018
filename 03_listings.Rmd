...
listings_neighbourhood_summary <- berlin_names %>%
  ...
  left_join(listings_neighbourhood_summary, by = c("id" = "neighbourhood")) %>%
  left_join(listings_neighbourhood_month_availability, by = c("id" = "neighbourhood")) %>%
  left_join(listings_neighbourhood_weekday_availability, by = c("id" = "neighbourhood")) %>%
  left_join(listings_neighbourhood_season_availability, by = c("id" = "neighbourhood")) %>%
  # left_join(listings_neighbourhood_daytype_availability, by = c("id" = "neighbourhood")) %>%
